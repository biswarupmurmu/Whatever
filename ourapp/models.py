...
class Customer(UserMixin, db.Model):
    ...
    Attributes:
        ...
        cart (relationship): Relationship to CartItem model, representing items in the customer's cart.
        orders (relationship): Relationship to Order model, representing orders made by the customer.
    """
...
class Product(db.Model):
    ...
    Attributes:
        ...
        categories (relationship): Relationship to Category model, representing categories the product belongs to.
        cart_items (relationship): Relationship to CartItem model, representing cart items associated with the product.
        ordered_items (relationship): Relationship to OrderedItem model, representing ordered items associated with the product.
    """
    id = db.Column(db.Integer, primary_key=True)
...
class Order(db.Model):
    ...
    Attributes:
        ...
        ordered_items (relationship): Relationship with OrderedItem objects associated with the order.
